      ...
      <div className="w-full overflow-hidden">
        <div className="title flex flex-col md:flex-row gap-2 justify-between my-4">
          ...
          <div className="flex gap-2 justify-end md:justify-normal text-black">
            <h3 className="dark:text-gray-200 text-sm">Items per page</h3>
            <select
              name="show"
        ...
        <div className="w-full overflow-x-auto custom-scrollbar">
          <table className="min-w-full">
            <thead className="bg-gray-200 dark:bg-black-500">
              {table.getHeaderGroups().map((headerGroup) => (
                <tr key={headerGroup.id} className="!border-px !border-gray-400 text-start dark:bg-boxDarkSecondary">
                  {headerGroup.headers.map((header) => {
                    return (
                      <th key={header.id} colSpan={header.colSpan} onClick={header.column.getToggleSortingHandler()} className="border-gray-200 bg-yellow py-3 px-2 text-start">
        ...
        <div className="flex justify-end px-4 py-2 border-t text-black">
          <div className="flex items-center mt-4 gap-2">
            ...
            <span className="flex items-center gap-1">
              <h3 className="dark:text-gray-100 text-sm">Page</h3>
