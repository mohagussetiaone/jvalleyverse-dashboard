          ...
          <div className="lg:w-1/2 w-full flex flex-col items-center justify-center">
            <div className="auth-box-3">
              ...
              <div className="text-center 2xl:mb-10 mb-5">
                <h4 className="font-medium text-2xl text-slate-900 dark:text-white mb-3">Sign up</h4>
                <div className="text-slate-500 dark:text-slate-400 text-base">Create an account to start using Dashcode</div>
              </div>
              <RegForm />
