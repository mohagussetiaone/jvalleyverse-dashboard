        ...
        <div className="lg:w-1/2 w-full flex flex-col items-center justify-center">
          <div className="auth-box-3">
            ...
            <div className="text-center mb-10">
              ...
              <div className="text-slate-500 dark:text-slate-400 text-base">Enter your password to unlock the screen!</div>
            </div>
            <div className="author-bio text-center mt-10 mb-8">
              <div className="h-14 w-14 mx-auto rounded-full">
                <img src={UserImage} alt="" className="w-full h-full object-cover block" />
              </div>
              <div className="text-slate-900 dark:text-white text-base font-medium mt-4">Kathryn Murphy</div>
            </div>
            <Lock />
